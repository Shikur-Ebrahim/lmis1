      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        */}
        <div className="relative bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          {/* Gradient Banner */}
          <div className="h-32 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 opacity-90 relative z-0">
          ...
          <div className="relative px-6 pb-6">
            <div className="flex flex-col sm:flex-row items-center sm:items-end -mt-12 mb-4">
              ...
              {/* Action Buttons */}
              <div className="mt-6 sm:mt-0 flex flex-wrap gap-2 w-full sm:w-auto">
                {/* Call */}
                <a
                  href={adminContact?.phoneNumber ? `tel:${adminContact.phoneNumber}` : `tel:${applicant.phoneNumber}`}
                  className="flex-1 sm:flex-none justify-center inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition-colors"
                >
                ...
                {/* Email */}
                <a
                  href={adminContact?.email ? `mailto:${adminContact.email}` : `mailto:${applicant.email}`}
                  className="flex-1 sm:flex-none justify-center inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 transition-colors"
                >
